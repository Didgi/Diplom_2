...
public class OrderSteps {
    ...
    private List<Integer> userOrdersList = new ArrayList<>();
    ...
    public ValidatableResponse createOrder(String[] ingredients, String token) {
        CreateOrderDto createOrderDto = new CreateOrderDto(ingredients);
        createOrderDto.setIngredients(ingredients);
        return orderClient.createOrder(createOrderDto, token).then();
    }
